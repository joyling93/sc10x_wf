...
hpca.se <- get(load("/repository/Test/scRNA_mj/SingleR_database/HumanPrimaryCellAtlas_hpca.se_human.RData"))
...
Idents(obj) <- 'singler'
obj.markers <- FindAllMarkers(obj, logfc.threshold=2, min.pct=0.1,only.pos = T) 
